...
export const mapConfigs = {
  ...
  7: { // 팔정도
    ...
    schedules: {
      ...
      { label: "Re:Blue", x: 31, y: 25 },
        { label: "카운셀러", x: 72, y: 25 },
        { label: "동국이네 슈퍼마켓", x: 20, y: 47 },
        { label: "자연순환보증금관리센터 x 코카콜라", x: 20, y: 65 },
  ...
  4: { // 만해/법학관
    ...
    schedules: {
      "2025-09-24:day": [ 
        { label: "야구부 프런트", x: 40, y: 30 },
        { label: "다독다독", x: 60, y: 30 },
      ],
      "2025-09-24:night": [
      ...
      "2025-09-25:day": [
        { label: "At!cha", x: 50, y: 70 },
        { label: "야구부 프런트", x: 40, y: 45 },
        { label: "다독다독", x: 60, y: 45 },
        { label: "더플레이", x: 50, y: 30 },
      ],
     "2025-09-25:night": [
        { label: "FOMU'LAW'1:법대의질주", x: 50, y: 70 },
        { label: "해탈해요\n 중생의숲", x: 50, y: 30 },
